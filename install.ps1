...
"@ | Set-Content -Path $shim -Encoding ascii
    ...
    Write-Host ""
    Write-Host "    crowsnest live --dashboard"
    Write-Host ""
    Write-Host "  It lists your network interfaces, marks the one your traffic"
    Write-Host "  actually uses, and asks which to watch -- press Enter to take"
    Write-Host "  the marked one. Press q to leave the dashboard. Drop"
    Write-Host "  --dashboard for a plain list, one line per host."
    Write-Host ""
